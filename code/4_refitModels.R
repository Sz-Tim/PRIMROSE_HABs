...
for(d in seq_along(covSets)) {
  fit.dir <- glue("{base.dir}/model_fits/{covSets[d]}/")
  cv.dir <- glue("{fit.dir}/cv/")
  ens.dir <- glue("{base.dir}/model_fits/ensembles/")
  out.dir <- glue("{base.dir}/compiled/{covSets[d]}/")
  ...
  foreach(i=seq_along(obs.ls),
    ...
    set.seed(1003)
    saveRDS(obs.ls[[i]], glue("data/1_current/{y}_{covSet}_dataFit.rds"))
